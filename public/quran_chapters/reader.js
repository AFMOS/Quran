(function(){
  ...
  var precacheUrls = ['index.html', 'search.html', 'early-theme.js', 'reader.js', 'ai-chat.js', 'surah-grid.js', 'quran-debug.js', 'surah_start_page.js', 'manifest.json', 'icon.svg', 'icon-192.png', 'icon-512.png'];
